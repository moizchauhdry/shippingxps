...
<section class="section section-height-4 section-with-shape-divider position-relative bg-dark border-0 m-0">
		...
		<div class="position-absolute top-0 left-0 h-100 d-none d-lg-block overlay overlay-show overlay-color-primary" style="width: 40%;"></div>
		<div class="container position-relative z-index-3 pt-5 mt-5">
			<div class="row align-items-center">
				<div class="col-lg-5 col-md-5">
					<div class="featured-img" style="margin:5px;">
						<img class="img-fluid" src="/theme/img/posters/poster-main.jpeg" alt="">
					</div>
				</div>
				<div class="col-lg-7 col-md-7">
					<div class="feature-img-meta d-flex justify-content-between text-center">
						<div class="featured-img" style="margin:5px;">
							<img class="img-fluid" src="/theme/img/posters/poster-1.jpeg" alt="">
						</div>
						<div class="featured-img" style="margin:5px;">
							<img class="img-fluid" src="/theme/img/posters/poster-2.jpeg" alt="">
						</div>
					</div>
					<div class="feature-img-meta d-flex justify-content-between text-center mt-5">
						<div class="featured-img" style="margin:5px;">
							<img class="img-fluid" src="/theme/img/posters/poster-3.jpeg" alt="">
						</div>
						<div class="featured-img" style="margin:5px;">
							<img class="img-fluid" src="/theme/img/posters/poster-4.jpeg" alt="">
						</div>
					</div>
