<template>
	<div class="container mt-5 mb-5">
		<div class="row">
			<div class="col-md-12">
				<h1 class="text-5 text-lg-5 text-xl-5 line-height-3 text-transform-none font-weight-semibold">
					Shipping Calculator
				</h1>
					...
					<form @submit.prevent="submit">
						<div class="d-flex justify-content-center">
							...
							<div class="form-group" v-show="form.ship_from == 'other'">
								<h6 for="city">City</h6>
								<input v-model="form.ship_from_city" type="text" class="form-control" />
							</div>

							<div class="form-group" v-show="form.ship_from == 'other'">
								<h6 for="zip">Zip</h6>
								<input v-model="form.ship_from_postal_code" type="text" class="form-control" />
							</div>
						</div>
						...
						<div class="d-flex justify-content-center">
							...
							<div class="form-group">
								<h6 for="">City</h6>
								<input v-model="form.ship_to_city" type="text" class="form-control" />
							</div>

							<div class="form-group">
								<h6>Zip</h6>
								<input v-model="form.ship_to_postal_code" type="text" class="form-control" />
							</div>
							<div class="form-group" v-if="form.ship_to_country_code != 'US'">
								<h6>Value</h6>
								<input v-model="form.customs_value" type="text" class="form-control" />
							</div>
						</div>

						<div class="d-flex justify-content-center p-2">
							<input type="checkbox" v-model="form.units" />
							<label for="" class="ml-1 mr-3">Metric <small>(kg/cm)</small></label>

							<input type="checkbox" v-model="form.address_type" />
							<label for="" class="ml-1">Residential</label>
						</div>

						<div class="d-flex justify-content-center" v-for="(item, index) in form.dimensions"
							:key="item.id">
							<div class="form-group">
								<h6>
							...
							<div class="form-group" v-show="index != 0">
								<a v-on:click="remove_dimension(index)" class="btn btn-link float-right font-bold">
						...
						<div class="d-flex justify-content-center">
							<button class="btn btn-link mt-2 mb-2 font-bold" v-on:click="add_dimension()">
							...
							<div class="row col-md-12">
								<div class="col text-center">
									<img class="d-inline-block img-fluid"
										src="/theme/img/demos/business-consulting-3/partner-02.png" alt="" />
								...
								<div class="col text-center">
									<img class="d-inline-block img-fluid"
										src="/theme/img/demos/business-consulting-3/partner-03.png" alt="" />
									<p class="text-0 font-weight-medium text-center mt-2">
										FedEx International
									</p>
								</div>
								<div class="col text-center">
									<img class="d-inline-block img-fluid"
										src="/theme/img/demos/business-consulting-3/partner-04.png" alt="" />
									<p class="text-0 font-weight-medium text-center mt-2">
										UPS International
									</p>
								</div>
				...
				<template v-if="shipping_rates.length == 0">
					<div class="d-flex justify-content-center">
						<a href="http://shippingxps.com">
							<img class="mt-4" alt="shippingxps" width="237" height="55" src="/theme/img/logo.png" />
						</a>
					</div>
