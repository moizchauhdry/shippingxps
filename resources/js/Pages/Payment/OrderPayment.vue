            ...
            <div class="container">
              ...
              <form @submit.prevent="submit" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-6 offset-md-3">
                    ...
                    <!-- COUPON SECTION -->
                    <!-- <div v-if="payment_module == 'package'" class="d-inline-flex mt-2 mb-2">
                    ...
                    <div class="row" v-show="payment_module == 'package' || form.shipping_address_id != null" >
                      ...
                      <div class="form-group col-4">
                        ...
                        <select v-model="form.year" class="form-control" name="year" required>
                          ...
                          <option v-for="n in 5" :value="n + (new Date().getFullYear())" :key="n">{{n + (new Date().getFullYear())}}</option>
                        </select>
                      </div>
                      <div class="form-group col-4">
                      ...
                      <table class="table" cols="4">
                        ...
                        <tr>
                          <th class="w-75 text-end">Total: <span class="text-lg ml-2">${{ amount }}</span></th>
                        </tr>
                        </tbody>
                      </table>
                      <div class="form-group col-12">
                        <input type="checkbox" id="terms" required> <label for="terms">By clicking here, I state that I have read and understood the</label> <inertia-link :href="route('page-show','terms_and_conditions')" class="link-hover-style-1">Terms and Conditions.</inertia-link>
                      </div>
                      <div class="form-group col-12">
                        <button type="submit" v-on:submit="submit()" class="btn btn-primary w-100"><span class="text-lg">Pay</span></button>
                      </div>
                    </div>
              ...
              <div class="row" v-show="payment_module == 'package' || form.shipping_address_id != null" >
                <div class="col-md-6 offset-md-3 text-center">
                  ...
                  <h5><strong>Pay by PayPal with {{ paypal_processing_fee }}% processing Fee.</strong></h5>
                  <div class="form-group mt-2 mb-2">
                    <input type="checkbox" id="termsPayPal" required> <label for="terms">By clicking here, I state that I have read and understood the</label> <inertia-link :href="route('page-show','terms_and_conditions')" class="link-hover-style-1">Terms and Conditions.</inertia-link>
                  </div>
                  <button class="btn btn-primary w-100" v-on:click="submitPayPal()"><span class="text-lg">${{ paypal_charged_amount }}</span></button>
                </div>
                <div class="col-md-6 offset-md-3">
...
export default {
  ...
  methods : {
    submit(){
      if(this.payment_module != 'package' && this.form.shipping_address_id == null){
