				...
				<div class="card-body">
					<div class="container">
						...
						<form @submit.prevent="submit" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-6 offset-md-3">
									<div
										class="bg-dark border-3 border-warning container mb-3 text-center text-white"
									>
									...
									>
										...
										<div class="form-group col-12" style="font-size: 12px">
											...
											<inertia-link
												...
												>Terms and Conditions.</inertia-link
											>
										</div>
										<div class="form-group col-12">
											<button
						...
						<div
							class="row"
							v-show="
								payment_module == 'package' || form.shipping_address_id != null
							"
						>
							<div class="col-md-6 offset-md-3 text-center">
								...
								<h5>
									<strong
										>Pay by PayPal with {{ paypal_processing_fee }}% processing
										Fee.</strong
									>
								</h5>
