...
<template>
	<MainLayout>
		<div role="main" class="main">
			...
			<section
				class="section top-section-padd section-with-shape-divider page-header page-header-modern page-header-lg border-0 my-0"
				...
				<div class="container">
					<div class="row">
						...
						>
							...
							<h1 class="font-weight-bold text-color-dark">
								Shipping Calculator
							</h1>
							<p class="text-4 font-weight-medium mt-3 mb-0">
								Shop from the USA and get your packages delivered to your
								doorstep with ease and without worry.
							</p>
						</div>
					</div>
				</div>
									...
									>
										<div class="row">
											...
											<div class="form-heading text-center mt-5">
												<span class="text-6 text-dark font-weight-bold">
													<input
														type="checkbox"
														name="is_residential"
														@change="is_residential($event)"
														style="line-height: 1; vertical-align: unset"
													/>&nbsp;&nbsp;Residential</span
												>
												<span class="text-6 text-dark font-weight-bold ms-5">
													<input
														type="checkbox"
														name="multiweight"
														:checked="multipiece"
														v-on:click="changeMultipiece()"
														style="line-height: 1; vertical-align: unset"
													/>&nbsp;&nbsp;Multipiece</span
												>
											</div>
											<div class="form-heading text-center mt-5">
												<h6 class="text-6 text-warning font-weight-bold">
													Tell us about the package size and weight.
												</h6>
											</div>
										</div>
										<div
										...
										<div class="dim-warning col text-center">
											<a class="" href="#"
												><i
													...
													aria-hidden="true"
												></i>
												Why dimensions matter? Learn more about "Volumetric"
												weight
											</a>
										</div>
				...
				<div class="container">
					<div class="col">
						...
						<template v-for="service in services" :key="service.service_id">
							<div
								v-if="service.isReady === true"
								class="free-services-meta mt-4 py-4"
							>
								<div class="row align-items-center">
									...
									<div class="col-md-4">
										<div class="services-title">
											...
											<strong
												class="text-4-5 font-weight-medium text-primary text-uppercase d-block mt-2"
											></strong>
										</div>
									</div>
									<div class="col-md-6">
										<div class="services-para">
											<div class="text-4-5 font-weight-normal">
				...
				axios
					...
					.then((response) => {
						...
						if (response.data.status) {
							...
							this.services[response.data.service.service_id] =
