			...
			<div class="card mb-5">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="warehouse_id" class="form-control custom-select" v-model="form.warehouse_id"
							...
							<div class="form-group">
								...
								<input v-model="form.site_name" class="form-control" type="text"
									placeholder="e.g Amazon, Alibaba etc." />
							</div>
							<div class="form-group">
								<breeze-label for="" value="Shop URL" />
								<input v-model="form.shop_url" type="url" class="form-control"
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<textarea v-model="form.notes" name="notes" id="notes" class="form-control"
							...
							<tbody>
								<template v-for="(item, index) in form.items">
									<tr>
										...
										<td>
											<input v-model="item.option" type="text" class="form-control item-desc"
				...
				<div class="card-footer">
					<div class="order-button">
						<input type="submit" value="Create Order" class="btn btn-danger float-right" />
					</div>
				</div>
			</div>
		</form>
