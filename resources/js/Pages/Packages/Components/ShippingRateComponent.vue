...
export default {
  ...
  methods: {
    getShippingRates() {
      ...
      var address_type = this.packag.address.is_residential == 1 ? true : false;
    ...
    setShippingService(rate) {
      ...
      if (result) {
        ...
        this.ship_service_form.price = rate.price;
        this.ship_service_form.markup_percentage = rate.markup_percentage;
