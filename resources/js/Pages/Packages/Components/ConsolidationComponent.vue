            ...
            <form @submit.prevent="submitConsolidateForm">
                <div class="row" v-for="(item,index) in consolidation_form.package_boxes" :key="item.id">
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <input v-model="item.weight" min="1" name="weight" id="weight" 
                        type="number" class="form-control" placeholder="Weight" :step="0.01" required/>
                    </div>
                    <div class="col-md-2 form-group">
                        <breeze-label for="length" value="Length"/>
                        <input v-model="item.length" min="1" name="length" id="length" 
                        type="number" class="form-control" placeholder="Length" required/>
                    </div>
                    <div class="col-md-2 form-group">
                        <breeze-label for="height" value="Height"/>
                        <input v-model="item.height" min="1" name="height" id="height" 
                        type="number" class="form-control" placeholder="Height" required/>
                    </div>
                    <div class="col-md-2 form-group">
                        <breeze-label for="width" value="Width"/>
                        <input v-model="item.width" min="1" name="width" id="width" 
                        type="number" class="form-control" placeholder="Width" required/>
                    </div>
                    <div class="col-md-2 form-group">
