<template>
	<template
		v-if="
			(packag.status == 'filled' || packag.status == 'labeled') &&
			packag.pkg_type == 'single'
		"
	>
		<div class="row">
			<div class="col-md-12">
								...
								<div class="col-md-5">
									<template v-if="form.service_id != null">
										<form @submit.prevent="submit">
											...
											<p style="color: red">
												Are you sure you want to use service? Add your message
												for admin and continue
											</p>
											<p style="color: red">
								...
								<template v-if="form_respond.request != null">
									...
									<form @submit.prevent="submitRespondForm">
										...
										<div class="form-group">
											...
											<textarea
												v-model="form_respond.admin_message"
												name="admin_message"
												id="admin_message"
												class="form-control"
