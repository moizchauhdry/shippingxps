                                ...
                                <div :class="getTabPaneClass('tab1')" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" style="background-color:white;">                                    
                                    ...
                                    <template v-for="order in packag.orders" :key="order.id">
                                        <div class="row" style="min-height:25px;">
                                            ...
                                            <div class="col-md-2">
                                                {{ order.tracking_number_in }}                                                
                                            </div>
                                            <div class="col-md-2">
                                                 {{ order.received_from }}         
                                            </div>
                                            <div class="col-md-2">
                                                 {{ order.package_weight }} {{ order.weight_unit }}          
                                            </div>
                                            <div class="col-md-2">
                                                 {{ order.package_length }} {{ order.dim_unit }} x {{ order.package_width }} {{ order.dim_unit }} x {{ order.package_height }} {{ order.dim_unit }}          
                                            </div>

                                            <div class="col-md-7" v-show="false">
                                                <h2>Items</h2>
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>                                               
                                                        <template v-for="item in packag.items" :key="item.id">
                                                            <tr v-if="item.order_id==order.id">
                                                                <td>{{ item.id }}</td>
                                                                <td>{{ item.name }}</td>
