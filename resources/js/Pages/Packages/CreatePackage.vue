                    ...
                    <fieldset class="mt-4 mb-2 border p-4">
                      <div class="col-md-12">                                          
                        ...
                        <div v-for="(item,index) in form.package_items" :key="item.id" class="row">
                          ...
                          <div class="col-md-1">
                            <div class="form-group">
                              <input v-model="item.quantity" name="quantity" min="1" id="quantity" type="number" class="form-control" 
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input v-model="item.unit_price" name="value" min="1" id="value" type="number" step="0.01" class="form-control" 
                        ...
                        <div class="col-md-1 offset-md-4" style="padding-right: 0px;">                        
                          ...
                          <div class="col-md-2" style="padding-right: 0px;">                        
                            <div class="form-group">
                              <input v-model="shipping_total" readonly name="shipping_total" id="shipping_total" type="text" class="form-control" required />
                            </div>
                          </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            getTotalValue(){
              return this.package_items.reduce(function(a, c){return a + Number((c.quantity*c.value) || 0)}, 0)
            },
            selectAddress(event){                
