<template>
        ...
        <section class="page-header page-header-modern page-header-background page-header-background-md parallax overlay overlay-color-dark overlay-show overlay-op-5 mt-0" data-plugin-parallax data-plugin-options="{'speed': 1.2}" data-image-src="img/page-header/page-header-parallax.jpg">
            <div class="container">
					...
					<div class="row py-4">
								...
								<div class="form-row">
									<div class="form-group col-md-12">
										...
										<select data-msg-required="Please enter the subject." class="form-control text-3 h-auto py-2" name="subject" id="subject" required>
											<option value="Cancellation &amp; Billing">Cancellation &amp; Billing</option><option value="Purchase a service">Purchase a service</option><option value="More information about Summit Stock services">More information about Summit Stock services</option><option value="Trouble logging in">Trouble logging in</option><option value="Issue with Scorecard">Issue with Scorecard</option><option value="Change my email preferences">Change my email preferences</option><option value="Change my account information">Change my account information</option><option value="Personal Data Request">Personal Data Request</option><option value="European Personal Data Request">European Personal Data Request</option>										
										</select>
									</div>
								</div>
								<div class="form-row">
						...
						<div class="col-lg-5">
							...
							<div class="overflow-hidden mb-1">
								<h4 class="text-primary mb-0 " data-="maskUp" data--delay="200">Get in <strong>Touch</strong></h4>
							</div>
							<div class="overflow-hidden mb-3">
								<p class="lead text-4 mb-0 " data-="maskUp" data--delay="400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eget leo at velit imperdiet varius. In eu ipsum vitae velit congue iaculis vitae at risus.</p>
							</div>
							<div class="overflow-hidden">
								<p class="mb-0 " data-="maskUp" data--delay="600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eget leo at velit imperdiet varius.</p>
							</div>

							<div class="" data-="fadeInUpShorter" data--delay="800">
				...
				<footer-component showTicker=false></footer-component>
</template>
<script>
