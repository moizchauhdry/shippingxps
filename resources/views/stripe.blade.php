...
<head>
    ...
    <script defer>
        ...
        async function initialize() {
            const token = document.querySelector('meta[name="csrf-token"]').getAttribute('content'); // Get the CSRF token from the HTML meta tag
        ...
        const { clientSecret } = await fetch("{{ route('stripe.create') }}", {
            method: "POST",
            headers: headers,
